...
class AuClearLookAndFeel : public juce::LookAndFeel_V4
{
  public:
    ...
    {
        const auto bounds =
            juce::Rectangle<float> ((float)x, (float)y, (float)width, (float)height).reduced (6.0f);
        ...
        {
            juce::Path p;
            p.addCentredArc (cx, cy, trackR, trackR, 0.0f, rotaryStartAngle, rotaryEndAngle, true);
        ...
        {
            juce::Path p;
            p.addCentredArc (cx, cy, trackR, trackR, 0.0f, rotaryStartAngle, angle, true);
